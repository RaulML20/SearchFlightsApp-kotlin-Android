...
class ListAdapter(context : Context, textL : List<String>, textD : List<String>, textP : List<String>, stars : List<Int>, icon : List<Int>, date : List<String>, sits: List<String>) : BaseAdapter() {
